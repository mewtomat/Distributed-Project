...
func (m *PutRequest) GetVer() int32 {
	if m != nil {
		return m.Ver
	}
	return -1
...
func (m *PutResponse) GetVote() bool {
	if m != nil {
		return m.Vote
	}
	return false
...
func (*Vote) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func init() {
	...
	proto.RegisterType((*Vote)(nil), "gmajpb.Vote")
}
