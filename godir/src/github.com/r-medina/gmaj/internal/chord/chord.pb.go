...
type ChordClient interface {
	...
	// SetPredecessor sets Node as the successor. This function does not do any
	// validation.
	SetNextSuccessor(ctx context.Context, in *gmajpb.Node, opts ...grpc.CallOption) (*gmajpb.MT, error)
	...
	PutKeyVal(ctx context.Context, in *gmajpb.KeyVal, opts ...grpc.CallOption) (*gmajpb.Vote, error)
...
func (c *chordClient) SetNextSuccessor(ctx context.Context, in *gmajpb.Node, opts ...grpc.CallOption) (*gmajpb.MT, error) {
	out := new(gmajpb.MT)
	err := grpc.Invoke(ctx, "/chord.Chord/SetNextSuccessor", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chordClient) PutKeyVal(ctx context.Context, in *gmajpb.KeyVal, opts ...grpc.CallOption) (*gmajpb.Vote, error) {
	out := new(gmajpb.Vote)
...
type ChordServer interface {
	...
	// SetNextSuccessor sets Node as the next_successor. This function does not do any
	// validation.
	SetNextSuccessor(context.Context, *gmajpb.Node) (*gmajpb.MT, error)
	// Notify notifies Chord that Node thinks it is our predecessor. This has
	// the potential to initiate the transferring of keys.
	...
	// PutKeyVal writes a key value pair to the node.
	PutKeyVal(context.Context, *gmajpb.KeyVal) (*gmajpb.Vote, error)
	// TransferKeys tells a node to transfer keys in a specified range to
	// another node.
...
func _Chord_SetNextSuccessor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(gmajpb.Node)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChordServer).SetNextSuccessor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chord.Chord/SetNextSuccessor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChordServer).SetNextSuccessor(ctx, req.(*gmajpb.Node))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Chord_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetNextSuccessor",
			Handler:    _Chord_SetNextSuccessor_Handler,
		},
		{
			MethodName: "Notify",
